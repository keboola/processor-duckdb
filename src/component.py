...
class Component(ComponentBase):
    ...
    def init_connection(self) -> duckdb.DuckDBPyConnection:
        ...
        config = dict(temp_directory=DUCK_DB_DIR, threads="4", memory_limit="512MB", max_memory="512MB")
    ...
    def create_table(self, input_table_config: Union[dict, str]) -> None:
        ...
        try:
            globals()[table_params.destination_table_name] = self._connection.read_csv(
                path_or_buffer=table_params.path,
                delimiter=delimiter,
                ...
                filename=add_filename_col,
                dtype=table_params.dtypes,
                all_varchar=table_params.all_varchar,
            )
